...
export const DEFAULT_INSTALLMENTS: { title: string; percent: number; detail: string; note: string }[] = [
  { title: 'งวดที่ 1', percent: 30, detail: '- ลงนามในสัญญาออกแบบพร้อมก่อสร้าง และ เริ่มเข้าเตรียมงานก่อสร้าง\n- มัดจำ เริ่มงานออกแบบ และเตรียมเอกสารแบบแปลน ยื่นขอใบอนุญาตก่อสร้าง\n** ระยะเวลายื่นขออนุญาต 45 วัน ทั้งนี้สามารถเริ่มก่อสร้างได้เลย โดยไม่ต้องรอใบอนุญาต **', note: 'ระยะเวลาขอใบอนุญาต 45 วัน' },
  { title: 'งวดที่ 2', percent: 10, detail: '- เตรียมการเคลียร์พื้นที่ ปรับพื้น ติดตั้งมิเตอร์น้ำไฟชั่วคราว\n- งานวางผัง ฐานราก ต่อม่อ', note: 'ระยะเวลาก่อสร้าง ตามสัญญา *นับตั้งแต่โอนมัดจำ เริ่มงานก่อสร้าง' },
  { title: 'งวดที่ 3', percent: 10, detail: '- งานโครงสร้าง คาน แล้วเสร็จ', note: '' },
  { title: 'งวดที่ 4', percent: 10, detail: '- งานโครงสร้างพื้นคอนกรีตแล้วเสร็จ', note: '' },
  { title: 'งวดที่ 5', percent: 10, detail: '- งานโครงสร้างเหล็กแล้วเสร็จ', note: '' },
...
/** สเปคมาตรฐานที่ตั้งต้นให้ใบเสนอราคาใหม่ — ตามฟอร์มใบเสนอราคาจริงของบริษัท */
export const DEFAULT_SPEC = 'SPEC : ส่วนโกดัง\n\nฐานราก\n- ฐานรากแบบแผ่ โดยวิศวะกรออกแบบ\n- พื้น GS หนา 0.15 m.\n- พื้น S วางแผ่นพื้น\nST 280 KSC CUBE\n\nโครงเหล็ก\n- เสา WF 200X100X8X12 mm\n- truss 75x75x2.3mm./50x50x2.3mm.\n- purlin / wall C100x50x20x2.3mm.\n\nหลังคาและผนัง\n- หลังคา เมทัลชีท 0.35 มม. บลูสโคป สีเลือกภายหลัง\n- สำนักงาน ก่ออิฐบล็อกฉาบเรียบทาสี\n\nระบบไฟฟ้าภายในแสงสว่าง 3 เฟส'
