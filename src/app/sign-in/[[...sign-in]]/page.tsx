  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#131011', padding: 20 }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ color: '#9c9093', fontFamily: 'var(--font-thai)', fontSize: 13, marginBottom: 22 }}>SBU1 · ระบบจัดการลูกค้า</p>
        <SignIn appearance={{ variables: { colorPrimary: '#d11f2a' } }} forceRedirectUrl="/" />
      </div>
    </main>
  )
}
